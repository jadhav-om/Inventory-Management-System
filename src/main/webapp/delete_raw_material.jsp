...
<%
    try {
        ...
        String deleteSql = "DELETE FROM raw_materials WHERE id = ?";
        ...
        if (rowsDeleted > 0) {
            ...
            String updateSql = "UPDATE raw_materials SET id = id - 1 WHERE id > ?";
            ...
            String selectSql = "SELECT * FROM raw_materials ORDER BY id";
        ...
        response.sendRedirect("view_raw_material.jsp");
