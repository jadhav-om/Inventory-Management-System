   ...
   <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4 text-center">View Issued Raw Material Logs</h1>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        try {
                                            ...
                                            ResultSet rs = stmt.executeQuery("SELECT * FROM issued_raw_materials");
                                            while (rs.next()) {
                                                String issuerID = rs.getString("issuer_id");
                                                String rawMaterialName = rs.getString("raw_material");
                                        ...
                                        <tr>
                                            ...
                                            <td><%= time %></td>
                                            <td>
                                              <a href="delete_issued_raw_material.jsp?id=<%= issuerID %>"
                                                   class="btn btn-primary btn-sm" > <!-- Add btn-primary class -->
