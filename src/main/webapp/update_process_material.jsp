...
<div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-center">Update Processed Material Quantity</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item">Dashboard</li>
                        <li class="breadcrumb-item active">Update Processed Material Quantity</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="UpdateProcessedMaterialServlet" method="post">
                                <div class="row">
