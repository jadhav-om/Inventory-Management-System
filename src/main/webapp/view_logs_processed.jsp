   ...
   <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4 text-center">View Issued Processed Material Logs</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item">Dashboard</li>
                    <li class="breadcrumb-item active">View Logs</li>
                    <li class="breadcrumb-item active">Processed</li>
                </ol>
                <div class="card mb-4">
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        ResultSet rs = stmt.executeQuery("SELECT * FROM issued_processed_materials");
                                        while (rs.next()) {
                                            String issuerID = rs.getString("issuer_id");
                                            String processedMaterialName = rs.getString("processed_material");
                                    ...
                                    <tr>
                                        <td><%= issuerID %></td>
                                        <td><%= processedMaterialName %></td>
                                        <td><%= quantity %></td>
                                        <td><%= issuerName %></td>
                                        <td><%= date %></td>
                                        <td><%= time %></td>
                                        <td>
                                            <a href="delete_issued_processed_material.jsp?id=<%= issuerID %>"
