  ...
  <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-center">Issue Processed Material</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item">Dashboard</li>
                        <li class="breadcrumb-item active">Issue Processed Material</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="IssueProcessedMaterialServlet" method="post">
                                <div class="row">
                                    <div class="col-md-6 offset-md-3">
                                        <div class="form-group">
                                            <label for="issuer_id">Issuer ID</label>
                                            <input type="text" class="form-control" id="issuer_id" name="issuer_id" placeholder="Enter Issuer ID" required>
                                        </div><br>
                                        <div class="form-group">
                                            <label for="processed_material">Select Processed Material</label>
                                            <select class="form-control" id="processed_material" name="processed_material" required>
                                                <option value="">Select Processed Material</option>
                                                <% 
                                                try {
                                                    Connection con = DBConnection.connect();
                                                    Statement stmt = con.createStatement();
                                                    ResultSet rs = stmt.executeQuery("SELECT name FROM pro_materials");
                                                    while (rs.next()) {
                                                        String processedMaterialName = rs.getString("name");
                                                %>
                                                <option value="<%= processedMaterialName %>"><%= processedMaterialName %></option>
                                                <% 
                                                    }
                                                    rs.close();
                                                    stmt.close();
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="issuer_name" name="issuer_name" placeholder="Enter Issuer Name" required>
                                        </div><br>
                                        <div class="form-group">
