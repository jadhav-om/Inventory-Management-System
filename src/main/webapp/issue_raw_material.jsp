   ...
   <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4 text-center">Issue Raw Material</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item">Dashboard</li>
                    <li class="breadcrumb-item active">Issue Raw Material</li>
                </ol>
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="IssueRawMaterialServlet" method="post">
                            <div class="row">
                                <div class="col-md-6 offset-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="raw_material" name="raw_material" required>
                                            <option value="">Select Raw Material</option>
                                            <% 
                                            try {
                                                Connection con = DBConnection.connect();
                                                Statement stmt = con.createStatement();
                                                ResultSet rs = stmt.executeQuery("SELECT name FROM raw_materials");
                                                while (rs.next()) {
                                                    String rawMaterialName = rs.getString("name");
                                            %>
                                            <option value="<%= rawMaterialName %>"><%= rawMaterialName %></option>
                                            <% 
                                                }
                                                rs.close();
                                                stmt.close();
